...
import {faFacebook, faGithub, faLinkedin, faNode, faReact, faXTwitter,} from "@fortawesome/free-brands-svg-icons";
import {faDatabase, faE, faEnvelope, faLocationDot, faPhone,} from "@fortawesome/free-solid-svg-icons";
      ...
      >
        ...
        >
          <div className="md:col-span-2 lg:col-span-1 flex flex-col gap-2">
            ...
            <p>Powered by MERN <FontAwesomeIcon icon={faDatabase}/> <FontAwesomeIcon icon={faE}/> <FontAwesomeIcon
                icon={faReact}/> <FontAwesomeIcon icon={faNode}/></p>
            <p>
              Website Design by {" "}
              <a
